            ...
            <div class="flex min-h-[70vh] flex-col items-center justify-center text-center">
                ...
                <div class="mt-12 text-center">
                    ...
                    <div class="flex flex-wrap items-center justify-center gap-6 text-sm">
                        <router-link
                            to="/about"
                            class="text-primary hover:text-red-500 transition-colors duration-200 hover:underline"
                        >
                            About Us
                        </router-link>
                        <router-link
                        ...
                        <!-- <router-link to="/help-center" class="text-primary hover:text-red-500 transition-colors duration-200 hover:underline">
              Help Center
            </router-link> -->
                    </div>
                </div>
