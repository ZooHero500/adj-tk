...
return [
    'aHeaderUpdateIsAlreadyAwaitingApproval' => 'Μια ενημέρωση κεφαλίδας αναμένει ήδη έγκριση',
    'acceptCommunityGuidelines' => 'Αποδοχή οδηγιών κοινότητας',
    ...
    'accountsCurated' => 'λογαριασμοί επιμελημένοι',
    'accountsPerKit' => 'Accounts per kit',
    'actions' => 'Ενέργειες',
    'active' => 'Ενεργή',
    'activeKits' => 'active kits',
    'add' => 'Προσθήκη',
    'addAName' => 'Προσθήκη ονόματος',
    'addATag' => 'Add a tag',
