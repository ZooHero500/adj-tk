...
return [
    ...
    'analyticsTrackingMessage' => 'Επέτρψε στο PornTk να παρακολουθεί τη χρήση σου για αναλυτικά στοιχεία και βελτίωση της υπηρεσίας.',
    'back' => 'Πίσω',
    ...
    'manageYourPornTkAccount' => 'Διαχείριση του Λογαριασμού PornTk σου',
